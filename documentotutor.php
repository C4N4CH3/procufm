...
$consulta="select count(id_tutor) as total_tutores from tutor_academico;";
$result = mysql_query($consulta) or die (mysql_error());
  if ($fila = mysql_fetch_array($result)) {
  $total_tu= $fila["total_tutores"];
  }
?>  
...
<title>Tutores Acad&eacute;micos</title>
...
<p align="justify"> Informaci&oacute;n de los Tutores Acad&eacute;micos disponibles:</p>
	<p align="center"><font color="#FF0000"> Hay <?php echo $total_tu?> Tutores Acad&eacute;micos inscritos!</font></p>
	<p>
	  <?php 

  $tutor="SELECT tu.nombre as tutor, tu.apellido as ape_tu, tu.cedula as cedula_tu, area_trabajo, c.nombre as nomcar, m.nombre as nommen FROM tipo_carrera c, tipo_mencion m, tutor_academico tu, preinscripcion p where c.id_carrera=tu.id_carrera and m.id_mencion=tu.id_mencion group by tutor order by tutor;"; 
   $resulta = mysql_query($tutor) or die (mysql_error());

echo  "<table align=center border=1>";
echo  "<tr>";
echo  "<td width=180 align=center>Nombre Tutor:</td>";
echo  "<td width=180 align=center>C&eacute;dula:</td>"; 
echo  "<td width=180 align=center>&Aacute;rea de Trabajo:</td>"; 
