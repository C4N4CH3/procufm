...
<form action="" method="post" id="form1" name="form1">     
    ...
    <table width="100%" border="0">    
        <tr>
            ...
            <td><input type="password" name="con_actual" id="con_actual" required size="15"></td>
        </tr>
        <tr>
            <td align="right" width="50%">Nueva contraseña:</td>
            <td><input type="password" name="con_nva" id="con_nva" required size="15"></td>
        </tr>
        <tr>
            <td align="right" >Confirme Nueva Contraseña:</td>
            <td ><input type="password" name="re_con_nva" id="re_con_nva" required size="15"></td>
        </tr>
        <tr>
