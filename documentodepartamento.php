...
<p align="justify">Si necesitas ver todos los documentos generados ingresa en este enlace: <a href="historialdocumentodepartamento.php">Historiales</a></p>
<p align="justify">Listado de los documentos solicitados por los alumnos:</p>
	<p align="center"><font color="#FF0000">Documentos pendientes por revisar!</font></p>
	<p>
	  <?php
...
if ($filalapso = mysql_fetch_array($resultadoLapso)){	
	...
	while ($filaPre = mysql_fetch_array($resultadoPre))
	{
		...
		$consultaDoc = "select * from documento where id_preinscripcion='$idPreinscripcion' and documento_estatus = 'noleido'";
		//echo $consultaDoc;
		...
		while($filaDoc = mysql_fetch_array($resultadoDoc)){
			...
			echo "<td><a href=verpdf.php?enviarDocumento=".$idDocumento."&&enviarIdAl=".$idCedulAlumno."&&enviarTipoDoc=".$idTipoDocumento." target=_blank>Ver</a></td>";
			echo "</tr>";
