...
//---------------------------------------------TRADUCCION EN ESPAÑOL-----------------------------------------------------------------------------
	...
	function popUpMonth() {
		...
		crossMonthObj.left = parseInt(crossobj.left) + 50 + 'px' // 266 -267 ddgf
...
//CAMBIA el siguiente for por este " for	(i=yearNow; i<=(yearNow+4); i++) { " si quieres que los años empizen en el actual en adelante		
	...
	function popUpYear() {
		...
		crossYearObj.left =	leftOffset + 'px' // 266 -267  338-339 ddgf
...
//------------------------------------TERMINAR LA FUNCION EN 0 PARA QUE INICIE EN EL DIA ACTUAL EN LA SIGUIENTE LINEA----------------------------------------------
				...
				// con esto funciona bien cuando le das click
				// estas son las lineas que cambie: 266 -267 338-339 591-592 ddgf
				// Importante: 266 -267 338-339 se le agrego solo en las lineas +"px" 
				// y en las lineas 591-592 me copie todo el codigo que sigue que esta marcado
				//desde aqui:
				if (ie) 
				{
