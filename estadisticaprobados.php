...
<p align="justify"> Consulta la informaci&oacute;n sobre los alumnos aprobados pertenecientes al Lapso actual.</p>
<p>
...
if ($filalapso = mysql_fetch_array($resultadoLapso)){	
	...
	while($filLap = mysql_fetch_array($resultadLap)){		
		...
		if($filaEs = mysql_fetch_array($resultadoEs)){
			...
			$consultaTablAlum = "select * from alumno where id_estatus='3' and cedula_alumno='$cedI'";
    ...
    <form action="verpdfaprobados.php" method="post" >
