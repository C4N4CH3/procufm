...
<div class="container">
  ...
  <div class="sidebar1"> 
    ...
    <ul class="nav">
      ...
      <li><a href="formulariocentropasantia.php"><img src="imagenes/blockcontentbullets.JPG" width="6" height="13" /><img src="imagenes/spacer.JPG" width="5" height="1" />Centro pasant&iacute;a</a></li>
  ...
  <div class="content">
    ...
    <table width="100%">
      ...
      <tr>
        ...
        <td><input name="nombre" type="text" onkeypress="return validarTextoNumero(event)" value="<?php if(isset($_POST['nombre'])) echo $_POST['nombre']?>" size="50" maxlength="50"></td>
        </tr>
      <tr>
        <td align="right">Ubicaci&oacute;n del Centro:</td>
        <td><input name="ubicacion" type="text" onkeypress="return validarTextoNumero(event)" value="<?php if(isset($_POST['ubicacion'])) echo $_POST['ubicacion']?>" size="50" maxlength="50"></td>
        </tr>
      <tr>
        <td align="right">Cantidad de pasantes:</td>
        <td><input name="num_pasante" type="text" onkeypress="return validarNumero(event)"  value="<?php if(isset($_POST['num_pasante'])) echo $_POST['num_pasante']?>"></td>
      </tr>
      <tr>
