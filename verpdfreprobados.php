...
if ($filalapso = mysql_fetch_array($resultadoLapso)){	
	...
	if($filaEs = mysql_fetch_array($resultadoEs)){
		...
		$consultaTablAlum = "select * from alumno where id_estatus='4'";
...
$pdf->ezText("\n A continuación se muestra el listado de Alumos Inscritos que Repobaron el proceso de Pasantías en el lapso establecido cumpliendo a cabalidad con los lineamientos dictados por el Departamento :\n ",12,array('justification'=>'full'));
