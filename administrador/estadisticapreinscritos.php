...
<div class="well col-md-9 col-lg-9 col-sm-9 col-xs-9" style="margin-left:20px">
  <blockquote>
    <h2>Repotes Preinscritos</h2>
  </blockquote>
<p align="justify"> Consulta la informaci&oacute;n sobre los alumnos PREINSCRITOS 
    pertenecientes a cualquier Lapso.</p>
<div>      
<?php 
    echo '<div align="center"><input type="hidden" name="id_estatus" id="id_estatus" value="1">';
