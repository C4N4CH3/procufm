...
<?php include_once '../navbar.php';?>
  ...
  <div class="well col-md-9 col-lg-9 col-sm-9 col-xs-9" style="margin-left:20px">
    ...
    <h2>Repotes Inscritos</h2>

<p align="justify"> Consulta la informaci&oacute;n sobre los alumnos INSCRITOS 
    pertenecientes a cualquier Lapso.</p>
<div>      
<?php 
    echo '<div align="center"><input type="hidden" name="id_estatus" id="id_estatus" value="2">';
